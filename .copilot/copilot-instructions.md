...
## Skill that governs every reply

- Load the `unslop` skill before any reply a human reads. It carries the
  register, terseness, and no-em-dash rules above in their canonical form;
  this file is the summary, the skill wins on conflict.
